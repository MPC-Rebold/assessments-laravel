...
new class extends Component {
    ...
    {
        $this->deleteConfirmed = trim($this->confirmDeleteString) === $this->assessment->master->title . '/' . $this->assessment->title;
    }
        ...
        <x-card title="Delete Assessment">
                ...
                <div class='rounded-lg border border-negative-600 bg-negative-50 p-4'>
                    <div class="flex items-center border-b-2 border-negative-200 pb-3">
                        ...
                        <span class="ml-1 text-lg text-negative-600">
                            ...
                            assessment&nbsp;<b>{{ $assessment->title }}</b>
                        </span>
                    </div>
            ...
            <x-slot name="footer">
                <div class="flex justify-between">
                    ...
                    <x-button spinner label="Confirm" wire:click="deleteAssessment" :disabled="!$deleteConfirmed" :secondary="!$deleteConfirmed"
