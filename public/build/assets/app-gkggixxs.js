...
const ht = (e) => {
    ...
    mt = A("AsyncFunction"),
    yt = (e) => e && (I(e) || R(e)) && R(e.then) && R(e.catch),
    a = {
        isArray: C,
        isArrayBuffer: ye,
        isBuffer: He,
...
function M(e, t, n) {
    ...
    function l(f, d, w) {
        ...
        return X(f) ? !0 : (t.append(ie(w, d, o), h(f)), !1);
    }
    const u = [],
        E = Object.assign(bt, {
            defaultVisitor: l,
            ...
            u.push(f),
                a.forEach(f, function (b, g) {
                    (!(a.isUndefined(b) || b === null) &&
                        s.call(t, b, a.isString(g) ? g.trim() : g, d, E)) ===
...
const Pe = {
    ...
    Tt = {
        isBrowser: !0,
        classes: { URLSearchParams: Rt, FormData: Ot, Blob: At },
        protocols: ["http", "https", "file", "blob", "url", "data"],
    },
    Ce = typeof window < "u" && typeof document < "u",
    gt = ((e) => Ce && ["ReactNative", "NativeScript", "NS"].indexOf(e) < 0)(
        ...
        return (
            ...
            p
                ...
                : ((!s[i] || !a.isObject(s[i])) && (s[i] = []),
                  t(n, r, s[i], o) && a.isArray(s[i]) && (s[i] = Ft(s[i])),
                  !c)
        );
    }
...
const ee = {
    ...
    transformRequest: [
        function (t, n) {
            ...
            return o || s
                ? (n.setContentType("application/json", !1), _t(t))
                : t;
        },
    ],
    transformResponse: [
            ...
            return new Promise(function (n, r) {
                ...
                if (a.isFormData(s)) {
                    if (
                        ...
                        O.hasStandardBrowserWebWorkerEnv
                    )
                        o.setContentType(!1);
                ...
                u.open(
                    ...
                    Ne(E, e.params, e.paramsSerializer),
                    !0,
                ),
                    (u.timeout = e.timeout);
                function S() {
                ...
                if (
                    ...
                    (u.onabort = function () {
                        u &&
                            (r(new m("Request aborted", m.ECONNABORTED, e, u)),
                            (u = null));
                    }),
                    (u.onerror = function () {
        ...
        getAdapter: (e) => {
            ...
            for (let o = 0; o < t; o++) {
                ...
                if (
                    ((r = n),
                    !Kt(n) &&
                        ((r = G[(i = String(n)).toLowerCase()]), r === void 0))
                )
